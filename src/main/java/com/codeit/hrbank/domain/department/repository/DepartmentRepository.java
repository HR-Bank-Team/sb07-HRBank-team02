...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
  ...
  @Query("""
          ...
          AND (
              ...
              (:sortField = 'establishedDate' AND (d.establishedDate > CAST(:lastValue AS java.time.LocalDateTime) OR 
                    (d.establishedDate = CAST(:lastValue AS java.time.LocalDateTime) AND d.id > :lastId)))
          )
      """)
  Slice<Department> searchByKeywordWithCursor(@Param("keyword") String keyword,
